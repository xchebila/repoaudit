...
| 2026-07-22 | Phase 3 (Security Diff Mode) | fixtures synthétiques (4 scénarios) | secret introduit, secret supprimé, problème préexistant non touché, décalage de ligne sans rapport, doublon de clé | `diff main <branche>` | négligeable (repos synthétiques minuscules) | les 4 scénarios corrects : NEW, FIXED, absence totale du problème préexistant, absence de faux NEW+FIXED sur décalage de ligne, comptage correct (1 FIXED, pas 0 ni 2) sur doublon |
