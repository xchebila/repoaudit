...
- Ni l'un ni l'autre n'a d'équivalent `--deps`/`--plugin` sur la branche "diff" du snippet, pour la même raison que `reposcan diff` lui-même n'en a pas (voir README).
